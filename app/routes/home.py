...
def export_pdf():
    ...
    title = Paragraph(
        "<b><font size='20'>MediVerse AI Prediction Report</font></b>",
        styles["Title"]
    )
    ...
    intro = Paragraph(
        ...
        <b>{current_user.name}</b> using the MediVerse AI Healthcare
    ...
    footer = Paragraph(
        "<i>Generated automatically by MediVerse AI.</i>",
        styles["Italic"]
    )
    ...
    return send_file(
        buffer,
        download_name="MediVerse_Report.pdf",
        as_attachment=True,
...
def export_excel():
    ...
    return send_file(
        output,
        download_name="MediVerse_Report.xlsx",
        as_attachment=True,
